...
const Editor = ({ mouse, keyboard }) => {
    ...
    useEffect(() => {
        ...
        if (!selectionTarget) {
            ...
            const { defaultLightEnabled: defaultLightEnabledInput, defaultFogEnabled: defaultFogEnabledInput } = addInputs(pane, "lighting & environment", settings, setupDefaults, sceneParams);
    ...
    return (_jsx("div", { ref: elRef, onKeyDown: (e) => e.stopPropagation(), onKeyUp: (e) => e.stopPropagation(), className: "lingo3d-ui", style: {
            width: 300,
            height: "100%",
