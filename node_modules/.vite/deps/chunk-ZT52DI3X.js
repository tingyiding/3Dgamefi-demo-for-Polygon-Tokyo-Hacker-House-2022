...
// node_modules/lingo3d/lib/display/core/mixins/PhysicsMixin/bvh/bvh.js
var CENTER = 0;
var AVERAGE = 1;
var SAH = 2;
var CONTAINED = 2;
...
MeshBVH.prototype.raycast = function(...args) {
  if (args[0].isMesh) {
    ...
    const [mesh, raycaster, ray2, intersects] = args;
...
MeshBVH.prototype.raycastFirst = function(...args) {
  if (args[0].isMesh) {
    ...
    const [mesh, raycaster, ray2] = args;
...
// node_modules/lingo3d/lib/display/core/mixins/PhysicsMixin/bvh/computeBVH.js
var bvhManagerMap = /* @__PURE__ */ new WeakMap();
var computeBVH_default = (item) => {
  item.outerObject3d.updateMatrixWorld(true);
  const geometries = [];
  item.outerObject3d.traverse((c) => {
    if (!c.geometry || c === getObject3d(item) && !(item instanceof Primitive_default))
      return;
...
//# sourceMappingURL=chunk-ZT52DI3X.js.map
