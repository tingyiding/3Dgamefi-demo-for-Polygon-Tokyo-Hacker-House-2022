...
var last = (val, index = -1) => val[val.length + index];
...
var applyMixins = (toClass, fromClasses) => {
  for (const fromClass of fromClasses)
    for (const name of Object.getOwnPropertyNames(fromClass.prototype))
      !(name in toClass.prototype) && Object.defineProperty(toClass.prototype, name, Object.getOwnPropertyDescriptor(fromClass.prototype, name) || /* @__PURE__ */ Object.create(null));
};
...
var diffAndRun = (handle, cleanup, fiber, getStates, statesOld, cb) => {
...
var createNestedEffect = (cb, getStates) => {
  const handle = fiberCache(() => {
    const parentHandle = fiberStack[fiberStack.length - 1].handle;
    return parentHandle.watch(new Cancellable(() => {
      var _a;
      return (_a = getCleanUp()) === null || _a === void 0 ? void 0 : _a();
    }));
  });
  if (handle.done)
    return handle;
 ...
 */
//# sourceMappingURL=chunk-NXCTIVNA.js.map
